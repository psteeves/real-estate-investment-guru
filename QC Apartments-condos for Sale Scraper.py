...
df_sale_condos.to_sql("Condos_Plexes_forSale", con=engine, if_exists="append", index=False)
...
df_sale_condos.to_excel(writer_master_hist, sheet_name=sheet_name_today, index=None)
writer_master_hist.save()
writer_master_hist.close()

# write this recent df in different Excel Doc named "Most Recent Condos"
df_sale_condos.to_excel(out_path_mostrecent, sheet_name=sheet_name_today)
